...
double arctanh1(const double x, const double delta); //Using constant values
...
int main()
{
   ...
   int length=1000;
   double tan1[length]; //Store the results of arctanh1 for each x value
   double tan2[length]; //Store the results of arctanh1 for each x value
